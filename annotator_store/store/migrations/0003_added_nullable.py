...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('store_annotation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'Annotation.user'
        db.alter_column('store_annotation', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['auth.User']))
    ...
    models = {
        ...
        'store.annotation': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': '-1', 'related_name': "'annotations'", 'null': 'True', 'blank': 'True', 'to': "orm['auth.User']"})
        },
        'store.permission': {
